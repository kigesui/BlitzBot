...
# import json
# import os
# from ..data.pokestats import PokeStats


class Cp():

    # LAZY_FILENAME = os.path.dirname(os.path.realpath(__file__))+"/lazy.json"

    def __init__(self):
        return
    #     self.__predefn_pokemons = Cp.get_predefn_pokelist()
    #     # self.__pokestats = PokeStats()
    #     return

    # @staticmethod
    # def get_predefn_pokelist():
    #     file = Cp.LAZY_FILENAME
    #     predefns = {}
    #     with open(file, "r") as fp:
    #         predefns = json.loads(fp.read())
    #     return predefns

    # @staticmethod
    # def get_parser():
    #     parser = argparse.ArgumentParser(prog="cp",
    #                                      description="some description")
    #     all_lists = Cp.get_predefn_pokelist().keys()
    #     list_str = "|".join(all_lists)
    #     parser.add_argument("-a", "--addlist",
    #                         nargs="+",
